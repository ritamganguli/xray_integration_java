...
public class calculatorTest {
	...
	public void lambdatest1() throws Exception {
		try {
			...
			System.out.println("Performing Some task for lambdatest 1...");
	...
	@Test
	public void lambdatest2() throws Exception {
		try {
			//Change it to production page
			System.out.println("Performing Some task for lambdatest 2...");
			driver.get("https://lambdatest.github.io/sample-todo-app/");
